...
const Service: React.FC = () => {
  ...
  // Categories with their respective services
  const categories = [
  ...
  return (
    <section className="relative py-16 sm:py-20 md:py-24 lg:py-32 overflow-hidden bg-gradient-to-br from-gray-950 via-gray-900 to-indigo-950">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-5 md:gap-6 pb-8 sm:pb-10 md:pb-12">
        ...
        {filteredServices.length === 0 && (
          <div className="text-center py-8 sm:py-10 md:py-12">
            <div className="w-16 h-16 sm:w-20 sm:h-20 bg-white/5 rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
              <Megaphone className="w-8 h-8 sm:w-10 sm:h-10 text-gray-500" />
            </div>
            <p className="text-sm sm:text-base text-gray-400">No services found in this category.</p>
          </div>
        )}
